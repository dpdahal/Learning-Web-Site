...
const UpdateQuestion = () => {
    ...
    let getQuestion = () => {
        api.get(`/question/${id}`).then((res) => {
            ...
            setOptionThree(question.optionThree);
            setOptionFour(question.optionFour);
            // checked question radio button if answer is true
            if (question.answer.includes(1)) {
                console.log("option one");
                setChecked([...checked, 1]);
            }
            if (question.answer.includes("optionTwo")) {
                setChecked([...checked, "optionTwo"]);
            }
            if (question.answer.includes("optionThree")) {
                setChecked([...checked, "optionThree"]);
            }
            if (question.answer.includes("optionFour")) {
                setChecked([...checked, "optionFour"]);
            }
        });
    }
                ...
                <div className="container question-add-page">
                    <div className="row">
                        <div className="col-md-12">
                            <h1>
                                <i className="bi bi-pencil-square"></i> Update Question</h1>
                            <hr/>
                        </div>
                        <div className="col-md-12">
